		...
		<div class="table-responsive col-sm-10">
			<table class="table table-condensed">
				...
				<tr>
					...
					<td>${o.orderDate}</td>
					<%
						com.WanXinyu.model.Order o=(com.WanXinyu.model.Order)pageContext.findAttribute("o");
						int userId=o.getCustomerId();
						java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
						com.WanXinyu.dao.UserDao userDao=new com.WanXinyu.dao.UserDao();
					...
					<td class="cart_total">
						<%
							...
							String paymentType=com.WanXinyu.model.Payment.findByPaymentId(con,n);
						%>
